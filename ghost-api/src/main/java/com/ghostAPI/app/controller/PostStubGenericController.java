...
import com.ghostAPI.app.serviceImpl.WireMockStubServiceImpl;
...
public class PostStubGenericController {
    ...
    @Autowired
    private WireMockStubServiceImpl wireMockStubService;
    ...
    public ResponseEntity<String> generateStub(@RequestBody String requestBody) {
        try {
            ...
            String result = wireMockStubService.saveStub(wireMockStub);
